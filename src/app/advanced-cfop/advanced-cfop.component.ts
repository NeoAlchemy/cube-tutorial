...
@Component({
  selector: 'app-advanced-cfop',
  templateUrl: './advanced-cfop.component.html',
  styleUrls: ['./advanced-cfop.component.less']
})
export class AdvancedCfopComponent implements AfterViewInit {
